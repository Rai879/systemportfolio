...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        <h2 class="h4">Edit Work Scope</h2>
        <p class="mb-0">Edit informasi cakupan pekerjaan</p>
    </div>
...
<div class="card">
    <div class="card-body">
        ...
        <form action="<?= base_url('/admin/work-scope/update/' . $workScope['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title" 
                           value="<?= old('title', $workScope['title']) ?>" required>
                </div>
                
                <div class="col-md-6 mb-3">
                    <label for="subtitle" class="form-label">Subjudul</label>
                    <input type="text" class="form-control" id="subtitle" name="subtitle" 
                           value="<?= old('subtitle', $workScope['subtitle']) ?>">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="5" 
                          required><?= old('description', $workScope['description']) ?></textarea>
            </div>
                        ...
                        <?php foreach($workScope['features'] as $feature): ?>
                            <div class="input-group mb-2">
                                <input type="text" class="form-control" name="features[]" 
                                       value="<?= $feature ?>" placeholder="Masukkan fitur cakupan pekerjaan">
