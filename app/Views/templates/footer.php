...
<style>
    .footer {
        ...
        padding: 40px 0 20px;
        margin-top: 60px;
        /* Beri jarak dari konten terakhir */
    }
</style>
<footer class="footer">
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4">
                <h5><?= 'PT. ' . ($siteSettings['site_name'] ?? 'Solusi teknologi terdepan untuk rumah sakit modern.') ?>
                </h5>
                ...
                <div class="social-links">
                    <?php if (isset($siteSettings['social_facebook'])): ?>
                        <a href="<?= $siteSettings['social_facebook'] ?>" class="text-light me-2" target="_blank"
                            rel="noopener"><i class="bi bi-facebook"></i></a>
                    <?php endif; ?>
                    <?php if (isset($siteSettings['social_instagram'])): ?>
                        <a href="<?= $siteSettings['social_instagram'] ?>" class="text-light me-2" target="_blank"
                            rel="noopener"><i class="bi bi-instagram"></i></a>
                    <?php endif; ?>
                    <?php if (isset($siteSettings['social_linkedin'])): ?>
                        <a href="<?= $siteSettings['social_linkedin'] ?>" class="text-light me-2" target="_blank"
                            rel="noopener"><i class="bi bi-linkedin"></i></a>
                    <?php endif; ?>
                    <?php if (isset($siteSettings['social_twitter'])): ?>
                        <a href="<?= $siteSettings['social_twitter'] ?>" class="text-light me-2" target="_blank"
                            rel="noopener"><i class="bi bi-twitter"></i></a>
                    <?php endif; ?>
                    <?php if (isset($siteSettings['social_youtube'])): ?>
                        <a href="<?= $siteSettings['social_youtube'] ?>" class="text-light me-2" target="_blank"
            ...
            <div class="col-md-4 mb-4">
                ...
                <p>
                    ...
                    <?= $siteSettings['contact_address'] ?? 'Jl. Contoh No. 123, Jakarta' ?><br>
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    <li><a href="<?= base_url('/about') ?>" class="text-light text-decoration-none">Tentang Kami</a>
                    </li>
                    ...
                    <li><a href="<?= base_url('/privacy-policy') ?>" class="text-light text-decoration-none">Privacy
                            Policy</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="text-center">
            <p>&copy; <?= date('Y') ?> All right reserved by
                <b><?= $siteSettings['site_name'] ?? 'Aplikasi Rumah Sakit' ?></b></p>
        </div>
    </div>
</footer>
