...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        <h2 class="h4">Edit About Company</h2>
        <p class="mb-0">Edit informasi tentang perusahaan</p>
    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="<?= base_url('/admin/about-company') ?>" class="btn btn-secondary">
...
<div class="card">
    <div class="card-body">
        ...
        <form action="<?= base_url('/admin/about-company/update/' . $aboutCompany['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="title" 
                           value="<?= old('title', $aboutCompany['title']) ?>" required>
                </div>
                
                <div class="col-md-6 mb-3">
                    <label for="subtitle" class="form-label">Subjudul</label>
                    <input type="text" class="form-control" id="subtitle" name="subtitle" 
                           value="<?= old('subtitle', $aboutCompany['subtitle']) ?>">
                </div>
            </div>

            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="years_experience" class="form-label">Tahun Pengalaman</label>
                    <input type="number" class="form-control" id="years_experience" name="years_experience" 
                           value="<?= old('years_experience', $aboutCompany['years_experience']) ?>">
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="5" 
                          required><?= old('description', $aboutCompany['description']) ?></textarea>
            </div>
