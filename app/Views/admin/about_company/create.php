...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        <h2 class="h4">Tambah About Company</h2>
        <p class="mb-0">Tambahkan informasi tentang perusahaan</p>
    </div>
...
<div class="card">
    <div class="card-body">
        <form action="<?= base_url('/admin/about-company/store') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
